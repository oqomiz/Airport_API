 ...
 */
final class Version20190214085342 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE flight (id INT NOT NULL, plane_id INT NOT NULL, pilot_id INT NOT NULL, departure_track_id INT DEFAULT NULL, arrival_track_id INT DEFAULT NULL, departure_terminal_id INT DEFAULT NULL, arrival_terminal_id INT DEFAULT NULL, departure_airport_id INT NOT NULL, arrival_airport_id INT NOT NULL, number VARCHAR(255) NOT NULL, departure_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, arrival_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_C257E60EE2AE981E ON flight (departure_track_id)');
        $this->addSql('CREATE INDEX IDX_C257E60E50C27FBF ON flight (arrival_track_id)');
        $this->addSql('CREATE INDEX IDX_C257E60E10C7954D ON flight (departure_terminal_id)');
        $this->addSql('CREATE INDEX IDX_C257E60E9D46EAF0 ON flight (arrival_terminal_id)');
        ...
        $this->addSql('CREATE TABLE plane (id INT NOT NULL, company_id INT NOT NULL, serial_number VARCHAR(15) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE track (id INT NOT NULL, airport_id INT NOT NULL, code VARCHAR(45) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE flight ADD CONSTRAINT FK_C257E60EE2AE981E FOREIGN KEY (departure_track_id) REFERENCES track (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE flight ADD CONSTRAINT FK_C257E60E50C27FBF FOREIGN KEY (arrival_track_id) REFERENCES track (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE flight ADD CONSTRAINT FK_C257E60E10C7954D FOREIGN KEY (departure_terminal_id) REFERENCES terminal (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE flight ADD CONSTRAINT FK_C257E60E9D46EAF0 FOREIGN KEY (arrival_terminal_id) REFERENCES terminal (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
